...
const HeaderTop = () => {
  ...
  return (
    <Fragment>
      <section className="container absolute inset-x-0 top-3 z-50 mx-auto px-5 md:top-8 lg:px-0 ">
        <article className="ml-4 -mb-[90px] h-[70px] rounded-lg bg-[#faa392] md:-mb-[105px] "></article>
        <article className="mr-3 mt-5 rounded-lg bg-[#002633]">
          <div className="container mx-auto grid grid-cols-3 px-[15px] py-[15px] xl:grid-cols-6">
                        ...
                        <div>
                          ...
                          <NavLink to={`/historyService`}>
                            <li className="group grid grid-cols-3 rounded-md py-0.5 px-3 hover:bg-[#f0699b] hover:text-white">
                              ...
                              <span className="col-span-2 block text-left">Dịch vụ </span>
                            </li>
                          </NavLink>
                          <NavLink to={`/historyTreatment`}>
                            <li className="group grid grid-cols-3 rounded-md py-0.5 px-3 hover:bg-[#f0699b] hover:text-white">
                              <span className="col-span-1 block text-left">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                              ...
                              <span className="col-span-2 block text-left">
                                Liệu trình{' '}
                              </span>
                            </li>
                          </NavLink>
      ...
      <Popover
        ...
        <Typography component="div" className="relative mr-96 h-[300px] w-[350px] p-0" sx={{}}>
          {noti.length !== 0 ? (
              ...
              noti.map((item, index) => {
                return (
                  <div
                    key={index}
                    className={
                      item.status === Number(Object.keys(notiSTT)[0]) ? 'bg-white' : ' shadow-xl '
                    }>
                    <div className="item grid cursor-pointer grid-cols-5 gap-5 border-b bg-white px-2 py-[5px] hover:bg-[rgb(248,248,248,0.9)] ">
                      <div className="img col-span-1 my-4">
                        <img
                      ...
                      <div className="content col-span-4 flex items-center justify-start">
                        <div>
