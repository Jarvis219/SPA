    ...
    <Fragment>
      <section className=" invisible fixed inset-y-0 right-0 z-40 flex items-center font-nunito transition duration-700 ease-in-out xl:visible">
        <div className="space-y-[1px]">
          <a href="https://www.facebook.com/Hills-Beauty-Spa-102513702455582" target="_blank">
          ...
          <a href="https://www.instagram.com/hills_beauty_spa/" target="_blank">
