        ...
        <ul
          ...
          <li className="nav-item flex-grow text-center" role="presentation">
            <Link
              ...
              className="active nav-link my-2 block w-full border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 font-nunito text-base font-semibold uppercase leading-tight hover:border-transparent hover:bg-gray-100 focus:border-transparent"
